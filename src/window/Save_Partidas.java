...
import static window.Registro.CB2;

/**
 *
 * @author danie
 */
public class Save_Partidas extends javax.swing.JFrame {
...
public void CargarRegistrar(){
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Partidas Guardadas");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 20, 470, 100));
        ...
        getContentPane().add(Import, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 20, 70, 70));
    ...
    private void ImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ImportActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Save_Partidas.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Save_Partidas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

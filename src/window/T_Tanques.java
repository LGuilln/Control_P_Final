...
public void CargarRegistrar(){
 ...
 public void readBinario_Taq(){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 40, 280, 100));

        jTableTanques.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jTableTanques.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Tanque", "Presicion", "Ataque", "Defensa", "Velocidad", "Precio"
            }
        ));
        jScrollPane1.setViewportView(jTableTanques);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        if(jTableTanques.getSelectedRow()==-1){
            if(jTableTanques.getRowCount()<=0){
            }else{
            }
        }else{
            if(JOptionPane.showConfirmDialog(null,"¿Eliminar Registro?")==0){
                DefaultTableModel model = (DefaultTableModel) jTableTanques.getModel();
                model.removeRow(jTableTanques.getSelectedRow());
            }
        }
...
// new NewJFrame().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(T_Tanques.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable jTableTanques;
